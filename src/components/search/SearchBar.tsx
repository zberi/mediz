...
export function SearchBar({
  ...
  return <div className={cn("relative", className)}>
      <form onSubmit={handleSearch} className="relative">
        <div className={cn("relative flex items-center bg-gradient-to-r from-card to-card transition-all duration-300 shadow-lg rounded-3xl border-4 border-dashed", isFocused ? "border-primary shadow-xl shadow-primary/20 scale-[1.01]" : "border-primary/30 hover:border-primary/50 hover:shadow-xl", seniorMode && "text-lg")}>
